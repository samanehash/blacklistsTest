...
##
bothSprot3FilteredColnames = bothSprot3Filtered.ix[2] #extract the columns names as they are placed in 3rd row
noSprot3FilteredColnames = noSprot3Filtered.ix[2]


rownames_bothSprot3Filtered = pd.Series(range(1,(len(bothSprot3Filtered)-2)))
rownames_noSprot3Filtered = pd.Series(range(1,(len(noSprot3Filtered)-2)))


bothSprot3Filtered = bothSprot3Filtered.rename(columns=bothSprot3FilteredColnames).drop(bothSprot3Filtered.index[:3]) #remove first two blancked rows and rename columns to real columns names
bothSprot3Filtered.index = rownames_bothSprot3incBlacklist #rename rows to start from 1
noSprot3Filtered = noSprot3Filtered.rename(columns=noSprot3FilteredColnames).drop(noSprot3Filtered.index[:3])
noSprot3Filtered.index = rownames_noSprot3Filtered


bothSprot3Filtered = bothSprot3Filtered["Evaluation-Score"] #filter columns except evaluation scores:
noSprot3Filtered = noSprot3incFiltered["Evaluation-Score"]
...
bothSprot3Filtered.columns = colnames
bothSprot3Filtered = bothSprot3Filtered.astype(float)
noSprot3Filtered.columns = colnames
noSprot3Filtered = noSprot3Filtered.astype(float)


#######################################################
################mean calculation#######################
###both Sprot3 incBlacklist
bothSprot3Filtered_AhrdMean = bothSprot3Filtered['AHRD Score'].mean()
bothSprot3Filtered_TairMean = bothSprot3Filtered['Tair Score'].mean()
bothSprot3Filtered_SprotMean = bothSprot3Filtered['SwissProt Score'].mean()
bothSprot3Filtered_TremMean = bothSprot3Filtered['Trembl Score'].mean()

###no Sprot3 incBlacklist
noSprot3Filtered_AhrdMean = noSprot3Filtered['AHRD Score'].mean()
noSprot3Filtered_TairMean = noSprot3Filtered['Tair Score'].mean()
noSprot3Filtered_SprotMean = noSprot3Filtered['SwissProt Score'].mean()
noSprot3Filtered_TremMean = noSprot3Filtered['Trembl Score'].mean()
...
ahrd_bothSprot3Filtered = bothSprot3Filtered.iloc[:,0]
ahrd_noSprot3Filtered = noSprot3Filtered.iloc[:,0]
 


result = pd.DataFrame({"Sprot3 incBlacklist_both blacklists AHRD": ahrd_bothSprot3Filtered, "Sprot3 incBlacklist_no blacklist AHRD": ahrd_noSprot3Filtered})
...
data = {'both_sprot3_Filtered': bothSprot3Filtered['AHRD Score'], 'no_sprot3_Filtered': noSprot3Filtered['AHRD Score']}
allAhrd = pd.DataFrame(data, columns=['both_sprot3_Filtered', 'no_sprot3_Filtered'])
#print allAhrd
...
#plt.show()
plt.savefig("/home/samaneh/AHRD/outputs/AHRDComparisonScatterMatrix_Sprot3Filtered.jpg")
plt.close()
