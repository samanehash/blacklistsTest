...
dataDfList.append(pd.read_excel(pd.ExcelFile("/home/samaneh/AHRD/outputs/xlsx/test_evaluator_output_combined_token_3.xlsx")))
...
plt.savefig("/home/samaneh/AHRD/outputs/AHRDComparison_combined.jpg")
#plt.show()
plt.close()
...
plt.savefig("/home/samaneh/AHRD/outputs/AHRDComparisonScatterMatrix_combined.jpg")
plt.close()
