...
db = "../data/db/TAIR10_pep_20101214_updated.fasta"
...
print "tair_words_count", len(wordsDictCount.keys())
...
#f = open('../outputs/firstWordsDictionary_tair.json','w')
...
#f = open('../outputs/wordsDictionary_tair.json','w')
