...
###Read Data
###change the direction to either batch 1 or 2
bothScoreDf = pd.read_excel(pd.ExcelFile("/home/samaneh/AHRD/outputs/xlsx/test_evaluator_output_both_tair10_2.xlsx")) # AHRD tsv outputs are converted to xlsx and are read here
tokScoreDf = pd.read_excel(pd.ExcelFile("/home/samaneh/AHRD/outputs/xlsx/test_evaluator_output_token_tair10_2.xlsx"))
noneScoreDf = pd.read_excel(pd.ExcelFile("/home/samaneh/AHRD/outputs/xlsx/test_evaluator_output_noBlacklist_tair10_2.xlsx"))
...
meanOut = open("/home/samaneh/AHRD/outputs/meanOutputs_Tair_2","w")
...
plt.savefig("/home/samaneh/AHRD/outputs/AHRDComparison_Tair_2.jpg")
plt.close()
