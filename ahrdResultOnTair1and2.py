...
dataDfList.append(pd.read_excel(pd.ExcelFile("/home/samaneh/AHRD/outputs/xlsx/test_evaluator_output_both_tair10_2.xlsx")))
dataDfList.append(pd.read_excel(pd.ExcelFile("/home/samaneh/AHRD/outputs/xlsx/test_evaluator_output_token_tair10_2.xlsx")))
dataDfList.append(pd.read_excel(pd.ExcelFile("/home/samaneh/AHRD/outputs/xlsx/test_evaluator_output_noBlacklist_tair10_2.xlsx")))
...
plt.savefig("/home/samaneh/AHRD/outputs/AHRDComparison_tair2.jpg")
#plt.show()
plt.close()
...
plt.savefig("/home/samaneh/AHRD/outputs/AHRDComparisonScatterMatrix_tair2.jpg")
plt.close()
