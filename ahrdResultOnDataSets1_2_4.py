...
###Read Data
bothScoreDf = pd.read_excel(pd.ExcelFile("/home/samaneh/AHRD/outputs/xlsx/test_evaluator_output_both_2.xlsx")) # AHRD tsv outputs are converted to xlsx and are read here
tokScoreDf = pd.read_excel(pd.ExcelFile("/home/samaneh/AHRD/outputs/xlsx/test_evaluator_output_token_2.xlsx"))
noneScoreDf = pd.read_excel(pd.ExcelFile("/home/samaneh/AHRD/outputs/xlsx/test_evaluator_output_noBlacklist_2.xlsx"))
###test
...
meanOut = open("/home/samaneh/AHRD/outputs/meanOutputs_2","w")
...
plt.savefig("/home/samaneh/AHRD/outputs/AHRDComparison_2.jpg")
#plt.show()
plt.close()
...
#plt.show()
plt.savefig("/home/samaneh/AHRD/outputs/AHRDComparisonScatterMatrix_2.jpg")
plt.close()